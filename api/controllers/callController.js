    ...
    for (let i = 0; i < data.length; i++) {
      ...
      try {
        ...
        callsToSave.push({
          ...
          first_dispose: String(getVal(['sub disposition', 'first dispose', 'sub_disposition', 'subdisposition', 'first_dispose', 'firstdispose']) || '').trim(),
          dispose: String(getVal(['disposition', 'dispose', 'status', 'call status', 'callstatus', 'call_status']) || '').trim(),
